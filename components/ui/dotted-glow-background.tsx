...
export const DottedGlowBackground = ({
  ...
  useEffect(() => {
    const compute = () => {
      ...
      const nextColor = isDark && darkColor ? darkColor : color;
      const nextGlow = isDark && darkGlowColor ? darkGlowColor : glowColor;
  ...
  useEffect(() => {
    ...
    const dpr = Math.min(Math.max(1, globalThis.devicePixelRatio || 1), 2);
